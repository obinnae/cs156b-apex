...
./run_matrix_factorization ../data/train.cdta ../data/probe.cdta 10 1 0.01 0.008 ../data/qual_um.dta ../submissions/probe_10features_1epochs.dta ../submissions/qual_10features_1epochs.dta
./run_matrix_factorization ../data/train.cdta ../data/probe.cdta 10 10 0.01 0.008 ../data/qual_um.dta ../submissions/probe_10features_10epochs.dta ../submissions/qual_10features_10epochs.dta
